  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-[#071426]/82 backdrop-blur-xl">
      <div className="mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <Link
          className="inline-flex min-h-11 items-center justify-center rounded-lg border border-[#c8a45d]/45 bg-[#c8a45d] px-5 text-sm font-semibold text-[#071426] shadow-[0_12px_36px_rgba(200,164,93,0.25)] transition hover:bg-[#e6d3a3] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#e6d3a3]"
          href={portalHref}
        >
          {portalLabel}
        </Link>
